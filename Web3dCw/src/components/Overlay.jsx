        ...
        <div className="bg-gradient-to-t from-white/90 pt-20 pb-10 p-4 flex items-center flex-col text-center">
          ...
          <div className="flex items-center gap-12 mt-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm opacity-80">Max Speed</p>
            </div>
          </div>
          <Link
            to={`/customize/${displaySlide}`}
            className="mt-8 px-6 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors z-30 pointer-events-auto"
          >
            Customize
          </Link>
